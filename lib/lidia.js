...
export function buildSystemPrompt(conv, products) {
  ...
  return `Voce e Lidia, assistente virtual da Talita Saude.

CONTEXTO: ${ctx}

FLUXO DE ATENDIMENTO:
1. Saudacao Inicial: Se nao souber o nome do cliente (informacao no CONTEXTO), voce deve obrigatoriamente responder exatamente: "Ola, sou a Lidia. Qual o seu nome?".
...
export async function callLidia(conv, userMsg, products) {
